...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "e1evenli"
  # s.authors            = { "e1evenli" => "email@address.com" }
  # s.social_media_url   = "http://twitter.com/e1evenli"
  ...
  s.source_files  = "HRVTableView/", "HRVTableView/HRVTableView.{h,m}"
